...
| W8N | Navigation and responsive chrome audit (73/100), 16 Sep. 26 findings. The chrome is mechanically sound at every width tested (320-2560, both orientations, 200%/400% zoom: no horizontal scroll, no clipping, reflow passes) and the failures are proportion and wayfinding: W8N.1 999 is not in the header (the only P0), W8N.2 the header takes up to 53% of a phone screen, W8N.3 twelve pages are orphaned and only one section has a subnav, W8N.4 no visible breadcrumb, W8N.5 a 2,109px footer on a 320px phone, W8N.6 no header search, W8N.7 the locale cookie does not survive a cached root redirect, W8N.8 polish. All eight open. |
