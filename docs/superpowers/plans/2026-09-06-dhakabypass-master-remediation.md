...
| W1.11 | Menus: seed built-ins, incremental edit, drag reorder, `TravelSubnav` menu-driven — **`TravelSubnav` menu-driven DONE** (`travel` menu, `section-subnav.menu` select, code list as outage fallback); seed/drag-reorder remain | A-P2-15, A-P2-16 | `menus/page.jsx:36-39`, `lib/menus/slugs.js`, `TravelSubnav.jsx:7-14` | Adding one nav item no longer replaces the whole menu |
