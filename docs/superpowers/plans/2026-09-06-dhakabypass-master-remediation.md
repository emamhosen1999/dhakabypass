...
| W8C | Concession-adequacy audit (32/100). Done 15 Sep: W8C.1 (999, calculator on open plazas only, % open corrected, unverified date removed); W8C.4 security.txt and X-Powered-By; W8C.7 status lookup and acknowledgement email; W8C.8 canonical redirects, share cards, Organization/WebSite/Breadcrumb/FAQ structured data; W8C.5/W8C.6 built with sample records (39) pending DBEDC's documents. Open: W8C.2 legal gate (needs counsel), W8C.3 real S.R.O.s, W8C.4 admin allow-list/DMARC/repo visibility (decisions), W8C.9 analytics and profiles (ownership). The supply register is docs/handover/2026-09-14-information-to-replace.md; the media brief docs/handover/2026-09-14-media-brief.md. |
