...
out = ["""-- 34-remaining-pages.sql — the master plan's W3, W4 and W5 pages, in English, Bangla and Chinese.
--
...
out.append("INSERT IGNORE INTO `schema_migrations` (`name`) VALUES ('34-remaining-pages');")
sql = "\n".join(line for line in out if "WHERE 1 = 0" not in line) + "\n"
open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'db', 'sql', '34-remaining-pages.sql'), 'w', encoding='utf-8', newline='\n').write(sql)
