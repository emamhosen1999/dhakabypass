...
import { NOT_FOUND_SLUG } from './slug.js';
 ...
 *
 * The not-found row is excluded (W8N.7, NAV-WAY-02). It is the CMS document
 * that RENDERS the 404 page, not a destination, and the route answers 404 by
 * design — so the site map, the one page whose job is that nothing is
 * unreachable, was publishing a broken link. `sitemap.xml` already excluded it.
 */
