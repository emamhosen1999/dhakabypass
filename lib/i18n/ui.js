...
export const UI = {
  ...
  bn: {
    navTravel: 'ভ্রমণ তথ্য', navProject: 'প্রকল্প',
    ...
    navReports: 'প্রতিবেদন ও পরিসংখ্যান', navEnvironment: 'পরিবেশগত ও সামাজিক সুরক্ষা', navPolicies: 'নীতিমালা', navConsultations: 'জনপরামর্শ', navPressReleases: 'প্রেস বিজ্ঞপ্তি', navPayment: 'টোল পরিশোধ', navBreakdown: 'বিকল যানবাহনে সহায়তা', navTollDispute: 'টোল বিরোধ',
    ...
    footerCompany: 'প্রতিষ্ঠান', footerDisclosure: 'তথ্য প্রকাশ', footerContact: 'সংবাদ ও সহায়তা', footerServices: 'অ্যাকাউন্ট ও সেবা', navLostFound: 'হারানো ও প্রাপ্তি', navOrganisation: 'DBEDC-এর সাংগঠনিক কাঠামো',
    ...
    statusKind: 'অনুরোধ', statusFiled: 'দাখিল', statusDue: 'উত্তরের সময়সীমা', statusResolved: 'নিষ্পত্তি', statusOverdue: 'সময়সীমা পেরিয়েছে',
    status_new: 'গৃহীত', status_in_progress: 'প্রক্রিয়াধীন', status_resolved: 'নিষ্পত্তি হয়েছে', status_closed: 'বন্ধ',
    ...
    requestKind_fleet_account: 'ফ্লিট অ্যাকাউন্টের জন্য আবেদন করুন', requestKind_etc_tag: 'ইলেকট্রনিক টোল ট্যাগের জন্য আবেদন করুন', requestKind_loyalty: 'নিয়মিত যাত্রী হিসেবে নিবন্ধন করুন',
    ...
    mapAltText: '{from} থেকে {to} পর্যন্ত Dhaka Bypass Expressway করিডোরের মানচিত্র, প্রতিটি অংশ যান চলাচলের অবস্থা অনুযায়ী রঙিন। একই তথ্য পাশের অংশ-তালিকায় রয়েছে।',
    mapNoGeometry: 'করিডোরের জ্যামিতি এখনও প্রকাশ করা হয়নি।',
    mapNoSections: 'এখনও কোনও অংশ প্রকাশ করা হয়নি।',
    trafficNoneMeasured: 'সরাসরি যান চলাচলের অবস্থা এখনও পরিমাপ করা হচ্ছে না। লাইভ ফিড যুক্ত হলে করিডোরের {n}টি অংশের অবস্থা ও গতি এখানে দেখা যাবে।',
    ...
    scrollForMore: 'আরও দেখতে পাশে স্ক্রল করুন', lastUpdated: 'সর্বশেষ হালনাগাদ', navHome: 'হোম',
    ...
    calcShowFare: 'ভাড়া দেখুন', mapOpenFull: 'পূর্ণ মানচিত্র খুলুন', liveTag: 'সরাসরি', liveJustNow: 'এইমাত্র হালনাগাদ', liveMinutesAgo: '{n} মিনিট আগে হালনাগাদ', plazaNotOpen: 'এখনো খোলা হয়নি', tollUnopenedBody: 'এই যাত্রায় এমন একটি টোল প্লাজা রয়েছে যা এখনো যান চলাচলের জন্য খোলা হয়নি। প্রদর্শিত ভাড়াটি খোলার পর প্রযোজ্য ঘোষিত হার।', scrollPrev: 'বাঁ দিকে সরান', scrollNext: 'ডান দিকে সরান', inThisSection: 'এই বিভাগে', backToTop: 'পাতার শুরুতে ফিরুন', breadcrumbLabel: 'আপনি এখানে আছেন', legalReviewTag: 'পর্যালোচনাধীন', legalReviewBody: 'এই পাতাটি DBEDC-এর আইন উপদেষ্টারা পর্যালোচনা করছেন। অনুমোদনের আগে এতে উল্লিখিত প্রতিশ্রুতি ও সময়সীমা পরিবর্তিত হতে পারে।', tollCitationPending: 'উদ্ধৃতি অপেক্ষমাণ: এই হার নির্ধারণকারী সরকারি প্রজ্ঞাপন প্রকাশিত হলে এখানে তালিকাভুক্ত হবে।', formPhoneHint: 'বাংলাদেশের মোবাইল নম্বর, যেমন 01711 000000 (+880 1711 000000)',
    ...
    searchLabel: 'সাইটে খুঁজুন', searchButton: 'খুঁজুন', searchCount: '“{q}”-এর জন্য {n}টি ফলাফল', searchNone: '“{q}”-এর সঙ্গে মেলে এমন কিছু সাইটে নেই। কম বা ভিন্ন শব্দ দিয়ে চেষ্টা করুন।', searchNews: 'সংবাদ', navSearch: 'অনুসন্ধান', printTable: 'প্রিন্ট করুন', shareLink: 'শেয়ার করুন', linkCopied: 'লিংক কপি হয়েছে', advisoriesNone: 'এই মুহূর্তে এক্সপ্রেসওয়েতে কোনো বন্ধ, সংস্কারকাজ বা বিজ্ঞপ্তি নেই।', advisoryUpcoming: 'আসন্ন', advisoryFrom: '{date} থেকে', advisoryUntil: '{date} পর্যন্ত', tollPayment: 'গৃহীত পরিশোধ পদ্ধতি',
    alertHeading: 'এসএমএস বা হোয়াটসঅ্যাপে সড়ক সতর্কবার্তা', alertPhone: 'মোবাইল নম্বর', alertChannel: 'সতর্কবার্তা পাঠানো হবে', alertConsent: 'এই নম্বরে DBEDC-এর সড়ক সতর্কবার্তা পেতে আমি সম্মত। যেকোনো সময় বাতিল করতে পারব।', alertConsentNeeded: 'সতর্কবার্তা পেতে সম্মতির ঘরে টিক দিন।', alertSubscribe: 'সাবস্ক্রাইব করুন', alertUnsubscribe: 'আনসাবস্ক্রাইব করুন', alertSwitchUnsubscribe: 'আমি বাতিল করতে চাই', alertSwitchSubscribe: 'আমি সাবস্ক্রাইব করতে চাই', alertOk: 'সাবস্ক্রাইব হয়েছে। সড়ক বন্ধ ও বড় সংস্কারকাজের সতর্কবার্তা পাবেন।', alertUnsubscribed: 'বাতিল হয়েছে। এই নম্বরে আর সতর্কবার্তা পাঠানো হবে না।', alertInvalid: 'বাংলাদেশের একটি মোবাইল নম্বর দিন, যেমন ০১৭১১-০০০০০০।', panoHint: 'চারপাশ দেখতে টানুন, সোয়াইপ করুন বা তীর চিহ্নের বোতাম ব্যবহার করুন।', panoPlay: 'ঘোরান', panoPause: 'ঘোরানো থামান', navAlerts: 'সড়ক সতর্কবার্তা', navFleet: 'ফ্লিট অ্যাকাউন্ট', navEtc: 'টোল ট্যাগ', navFrequent: 'নিয়মিত যাত্রী', navRecognition: 'স্বীকৃতি', navVideos: 'ভিডিও', navTour: '৩৬০° ভ্রমণ',
    cameraLive: 'সরাসরি', cameraOnline: 'চালু', cameraOffline: 'বন্ধ', cameraSample: 'নমুনা', cameraWatch: 'সরাসরি দেখুন', cameraStop: 'সরাসরি দেখা বন্ধ করুন', cameraUpdated: '{time}-এ হালনাগাদ', cameraStill: 'সর্বশেষ ছবি', cameraSampleNote: 'এই ছবিগুলো সংযোগাধীন ক্যামেরা ফিডের পরিবর্তে দেখানো হচ্ছে। এগুলো সরাসরি নয়।', camerasNone: 'এই মুহূর্তে কোনো ক্যামেরা পাওয়া যাচ্ছে না।', navCameras: 'ট্রাফিক ক্যামেরা',
    navAdvisories: 'সড়ক বন্ধ ও বিজ্ঞপ্তি', navVehicleClasses: 'যানবাহনের শ্রেণি', navFreight: 'পণ্য পরিবহন', navConcession: 'কনসেশন', navCareers: 'ক্যারিয়ার', navMedia: 'মিডিয়া', navRti: 'তথ্য অধিকার', navCitizenCharter: 'নাগরিক সনদ', navIntegrity: 'শুদ্ধাচার', navFaq: 'সচরাচর জিজ্ঞাসা', navDownloads: 'ডাউনলোড', navSitemap: 'সাইট ম্যাপ', quoteSource: 'সূত্র', mapM: 'মি',
