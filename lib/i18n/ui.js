...
export const UI = {
  en: {
    ...
    blockInEnglish: 'This section is shown in English because it has not been translated yet.', quoteSource: 'Source', mapM: 'm',
  ...
  bn: {
    ...
    blockInEnglish: 'এই অংশটি এখনও অনূদিত হয়নি, তাই ইংরেজিতে দেখানো হচ্ছে।', quoteSource: 'সূত্র', mapM: 'মি',
  ...
  zh: {
    ...
    blockInEnglish: '本部分尚未翻译，暂以英文显示。', quoteSource: '来源', mapM: '米',
