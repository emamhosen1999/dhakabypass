...
export const UI = {
  ...
  zh: {
    ...
    calcShowFare: '查看费用', legalReviewTag: '审核中', legalReviewBody: '本页正由DBEDC法律顾问审核。批准前，页面中的承诺和时限可能会有变动。', tollCitationPending: '引用待定：确定这些费率的政府通告公布后将在此列出。', formPhoneHint: '孟加拉国手机号，例如 01711 000000（+880 1711 000000）',
