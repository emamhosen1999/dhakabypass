...
export const UI = {
  en: {
    ...
    blockInEnglish: 'This section is shown in English because it has not been translated yet.', tollInForceSince: 'In force since {date}', segmentOpened: 'Opened {date}', segmentExpected: 'Expected to open {date}', quoteSource: 'Source', mapM: 'm',
  ...
  bn: {
    ...
    blockInEnglish: 'এই অংশটি এখনও অনূদিত হয়নি, তাই ইংরেজিতে দেখানো হচ্ছে।', tollInForceSince: '{date} থেকে কার্যকর', segmentOpened: '{date} তারিখে খোলা হয়েছে', segmentExpected: '{date} তারিখে খোলার কথা', quoteSource: 'সূত্র', mapM: 'মি',
  ...
  zh: {
    ...
    blockInEnglish: '本部分尚未翻译，暂以英文显示。', tollInForceSince: '自 {date} 起施行', segmentOpened: '{date} 通车', segmentExpected: '预计 {date} 通车', quoteSource: '来源', mapM: '米',
