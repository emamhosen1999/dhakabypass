...
export const UI = {
  en: {
    ...
    scrollForMore: 'Scroll sideways for more', lastUpdated: 'Last updated',
  ...
  bn: {
    ...
    scrollForMore: 'আরও দেখতে পাশে স্ক্রল করুন', lastUpdated: 'সর্বশেষ হালনাগাদ',
  ...
  zh: {
    ...
    scrollForMore: '横向滚动查看更多', lastUpdated: '最后更新',
