...
export const UI = {
  en: {
    ...
    searchLabel: 'Search the site', searchButton: 'Search', searchCount: '{n} results for “{q}”', searchNone: 'Nothing on the site matches “{q}”. Try fewer or different words.', searchNews: 'News', navSearch: 'Search', printTable: 'Print', shareLink: 'Share', linkCopied: 'Link copied', quoteSource: 'Source', mapM: 'm',
  ...
  bn: {
    ...
    searchLabel: 'সাইটে খুঁজুন', searchButton: 'খুঁজুন', searchCount: '“{q}”-এর জন্য {n}টি ফলাফল', searchNone: '“{q}”-এর সঙ্গে মেলে এমন কিছু সাইটে নেই। কম বা ভিন্ন শব্দ দিয়ে চেষ্টা করুন।', searchNews: 'সংবাদ', navSearch: 'অনুসন্ধান', printTable: 'প্রিন্ট করুন', shareLink: 'শেয়ার করুন', linkCopied: 'লিংক কপি হয়েছে', quoteSource: 'সূত্র', mapM: 'মি',
  ...
  zh: {
    ...
    searchLabel: '搜索本站', searchButton: '搜索', searchCount: '“{q}”共有 {n} 条结果', searchNone: '本站没有与“{q}”匹配的内容。请尝试更少或不同的词语。', searchNews: '新闻', navSearch: '搜索', printTable: '打印', shareLink: '分享', linkCopied: '链接已复制', quoteSource: '来源', mapM: '米',
