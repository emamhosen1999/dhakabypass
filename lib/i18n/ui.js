...
export const UI = {
  en: {
    ...
    calcShowFare: 'Show the fare', scrollPrev: 'Scroll left', scrollNext: 'Scroll right', inThisSection: 'In this section', backToTop: 'Back to the top of the page', breadcrumbLabel: 'You are here', legalReviewTag: 'Under review', legalReviewBody: 'This page is being reviewed by DBEDC’s legal advisers. Commitments and time limits on it may change before it is approved.', tollCitationPending: 'Citation pending: the government notification that sets these rates will be listed here once published.', formPhoneHint: 'A Bangladesh mobile, for example 01711 000000 (+880 1711 000000)',
  ...
  bn: {
    ...
    calcShowFare: 'ভাড়া দেখুন', scrollPrev: 'বাঁ দিকে সরান', scrollNext: 'ডান দিকে সরান', inThisSection: 'এই বিভাগে', backToTop: 'পাতার শুরুতে ফিরুন', breadcrumbLabel: 'আপনি এখানে আছেন', legalReviewTag: 'পর্যালোচনাধীন', legalReviewBody: 'এই পাতাটি DBEDC-এর আইন উপদেষ্টারা পর্যালোচনা করছেন। অনুমোদনের আগে এতে উল্লিখিত প্রতিশ্রুতি ও সময়সীমা পরিবর্তিত হতে পারে।', tollCitationPending: 'উদ্ধৃতি অপেক্ষমাণ: এই হার নির্ধারণকারী সরকারি প্রজ্ঞাপন প্রকাশিত হলে এখানে তালিকাভুক্ত হবে।', formPhoneHint: 'বাংলাদেশের মোবাইল নম্বর, যেমন 01711 000000 (+880 1711 000000)',
  ...
  zh: {
    ...
    calcShowFare: '查看费用', scrollPrev: '向左滚动', scrollNext: '向右滚动', inThisSection: '本栏目', backToTop: '返回页首', breadcrumbLabel: '当前位置', legalReviewTag: '审核中', legalReviewBody: '本页正由DBEDC法律顾问审核。批准前，页面中的承诺和时限可能会有变动。', tollCitationPending: '引用待定：确定这些费率的政府通告公布后将在此列出。', formPhoneHint: '孟加拉国手机号，例如 01711 000000（+880 1711 000000）',
