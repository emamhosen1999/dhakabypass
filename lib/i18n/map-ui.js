...
const labels = {
  ...
  bn: { title:'ঢাকা বাইপাস', subtitle:'করিডোর ম্যাপ', map:'ম্যাপ', layers:'স্তর', landmarks:'গুরুত্বপূর্ণ স্থান', connections:'অতিক্রমকারী ও সংযোগ সড়ক', traffic:'যানবাহনের অবস্থা', laneTitle:'সড়কের বিন্যাস', toll:'টোল সড়ক', service:'সার্ভিস সড়ক', laneNote:'প্রস্থ প্রতীকীভাবে দেখানো হয়েছে', crossing:'অতিক্রমকারী সড়ক', connected:'সংযোগ সড়ক', highlight:'প্রতিটি দিকে সড়ক বরাবর সর্বোচ্চ ২ কিমি', north:'উ', data:'ম্যাপের ডেটা', details:'সড়কাংশের বিবরণ', mapNote:'ভৌগোলিক ম্যাপ · OpenStreetMap' },
