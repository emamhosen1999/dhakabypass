 ...
 * read, and `public/brand/dbedc-mark.svg` — the vector mark that reverses via
 * `currentColor` — is a plausible future value for this setting. schema.org
...
export async function loadOrganization() {
  ...
  return organizationJsonLd({ name: seo.orgName, alternateName: seo.orgShortName, logo });
}
