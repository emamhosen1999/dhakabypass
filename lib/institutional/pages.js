 ...
 *
 * The 2026-09-06 content recovery audit additionally corroborates the RHD and
 * consortium identities, the 2018 contract and the first BIFFL disbursement in
 * 2022. These are linked to the public records and described as history.
 *
 * Other information a page of this kind would normally state — the concession
...
// The client authorised restoring previous-site claims with a visible dated
// provenance notice on 2026-09-06. They must never read as current facts.
function historical(locale, body) {
  const labels = {
    en: ['Previous website information', 'Recovered from the previous website. These details may have changed and are not confirmed as current.'],
    bn: ['আগের ওয়েবসাইটের তথ্য', 'আগের ওয়েবসাইট থেকে সংরক্ষিত তথ্য। এগুলি পরিবর্তিত হয়ে থাকতে পারে এবং বর্তমান তথ্য হিসেবে নিশ্চিত নয়।'],
    zh: ['旧版网站信息', '以下内容恢复自旧版网站，可能已有变化，尚未确认为当前信息。'],
  };
  const [tag, note] = labels[locale];
  return `<div class="db-archive"><p class="db-archive-notice"><strong class="db-archive-tag">${tag}</strong>${note}</p>${body}</div>`;
}
      ...
      data: {
        en: {
          ...
          body:
            ...
            + "<p>The Roads and Highways Department is the implementing agency. PPPA records a contract signed on 6 December 2018 with a consortium of Sichuan Road and Bridge (Group) Corporation Ltd, Shamim Enterprise (Pvt) Ltd and UDC Construction Ltd. <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA project profile</a>.</p>",
        },
        bn: {
          heading: 'আমাদের কাজ',
          body:
            ...
            + "<p>সড়ক ও জনপথ অধিদপ্তর বাস্তবায়নকারী সংস্থা। PPPA-এর নথি অনুযায়ী Sichuan Road and Bridge (Group) Corporation Ltd, Shamim Enterprise (Pvt) Ltd এবং UDC Construction Ltd-এর কনসোর্টিয়ামের সঙ্গে ৬ ডিসেম্বর ২০১৮ চুক্তি স্বাক্ষরিত হয়। <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA প্রকল্প পরিচিতি</a>।</p>",
        },
        zh: {
          heading: '我们的职责',
          body:
            ...
            + "<p>实施机构为孟加拉国公路局（RHD）。PPPA 记录显示，合同于 2018 年 12 月 6 日与 Sichuan Road and Bridge (Group) Corporation Ltd、Shamim Enterprise (Pvt) Ltd 及 UDC Construction Ltd 组成的联合体签署。<a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA 项目资料</a>。</p>",
        },
      },
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            ...
            + "<p>The public partner is the Roads and Highways Department. The private consortium comprises Sichuan Road and Bridge (Group) Corporation Ltd, Shamim Enterprise (Pvt) Ltd and UDC Construction Ltd. <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">Source: PPPA</a>.</p>" + historical('en', "<p>The previous site described a 25-year concession covering design, construction, finance, operation, maintenance and transfer. It listed the ownership as SRBG 60%, Shamim Enterprise 30% and UDC Construction 10%.</p><p>It identified China Development Bank and BIFFL as lenders and described financing agreements signed in April 2021. The current concession terms and ownership should be checked with DBEDC.</p>"),
        },
        bn: {
          ...
          body:
            ...
            + "<p>সরকারি অংশীদার সড়ক ও জনপথ অধিদপ্তর। বেসরকারি কনসোর্টিয়ামে রয়েছে Sichuan Road and Bridge (Group) Corporation Ltd, Shamim Enterprise (Pvt) Ltd এবং UDC Construction Ltd। <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">সূত্র: PPPA</a>।</p>" + historical('bn', "<p>আগের সাইটে নকশা, নির্মাণ, অর্থায়ন, পরিচালনা, রক্ষণাবেক্ষণ ও হস্তান্তরসহ ২৫ বছরের কনসেশনের কথা ছিল। সেখানে মালিকানা হিসেবে SRBG ৬০%, Shamim Enterprise ৩০% এবং UDC Construction ১০% উল্লেখ করা হয়েছিল।</p><p>ঋণদাতা হিসেবে China Development Bank ও BIFFL এবং এপ্রিল ২০২১-এ অর্থায়ন চুক্তির উল্লেখ ছিল। বর্তমান চুক্তির শর্ত ও মালিকানা DBEDC-এর কাছে যাচাই করুন।</p>"),
        },
        zh: {
          heading: '合同架构',
          body:
            ...
            + '以及由谁答复投诉。</p>'
            + "<p>公共合作方为公路局（RHD），私人联合体由 Sichuan Road and Bridge (Group) Corporation Ltd、Shamim Enterprise (Pvt) Ltd 和 UDC Construction Ltd 组成。<a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">来源：PPPA</a>。</p>" + historical('zh', "<p>旧版网站描述了涵盖设计、建设、融资、运营、养护及移交的 25 年特许经营期，并列出 SRBG 持股 60%、Shamim Enterprise 持股 30%、UDC Construction 持股 10%。</p><p>旧资料将 China Development Bank 和 BIFFL 列为贷款方，并提及 2021 年 4 月签署的融资协议。当前经营条款与持股情况请向 DBEDC 核实。</p>"),
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            historical('en', "<ul><li>Liu Xiaobo — Chairman</li><li>Xiao Zhiming — Chief Executive Officer</li><li>Md. Shafiqul Islam Akand — Chief Operating Officer</li><li>Syed Aslam Ali — RHD Project Director</li></ul><p>Names and titles are reproduced as listed on the previous website; this is an archived roster, not a current staff directory.</p>"),
        },
        bn: {
          heading: 'পরিচালনা পর্ষদ ও ঊর্ধ্বতন ব্যবস্থাপনা',
          body:
            historical('bn', "<ul><li>Liu Xiaobo — চেয়ারম্যান</li><li>Xiao Zhiming — প্রধান নির্বাহী কর্মকর্তা</li><li>Md. Shafiqul Islam Akand — প্রধান পরিচালন কর্মকর্তা</li><li>Syed Aslam Ali — RHD প্রকল্প পরিচালক</li></ul><p>নাম ও পদবি আগের ওয়েবসাইট অনুযায়ী সংরক্ষিত। এটি পুরোনো তালিকা, বর্তমান কর্মকর্তা তালিকা নয়।</p>"),
        },
        zh: {
          heading: '董事会与高级管理层',
          body:
            historical('zh', "<ul><li>Liu Xiaobo — 董事长</li><li>Xiao Zhiming — 首席执行官</li><li>Md. Shafiqul Islam Akand — 首席运营官</li><li>Syed Aslam Ali — RHD 项目主任</li></ul><p>姓名与职务按旧版网站保留，属于历史名单，并非现任人员名录。</p>"),
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            "<p>Project history: the PPP contract was signed on 6 December 2018. BIFFL reports that its first loan disbursement to the project was made in April 2022. These are historical milestones, separate from the road’s current operating status. <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA project profile</a>; <a href=\"https://www.biffl.org.bd/uploads/images/reports/BIFFL%20Annual%20Report%202022%20Final%20Update.pdf\">BIFFL annual report 2022, page 88</a>.</p>" + historical('en', "<p><strong>Construction snapshot dated 31 December 2024:</strong> the previous project page reported overall progress of 69.11%, earthworks at 82.89%, pavement at 53.95%, foundations at 100% and structures at 90.9%.</p><p>It described an initial project investment of US$412 million and an appointed date of 15 May 2022. These are figures reported by the previous site, not an updated financial statement.</p><p>The old July 2025 and December 2025 opening targets are historical targets that have passed. They do not indicate that the remaining road is open. Use the route map for the published operating status.</p>"),
        },
        bn: {
          heading: 'কর্মসূচি ও ব্যয়',
          body:
            "<p>প্রকল্পের ইতিহাস: ৬ ডিসেম্বর ২০১৮ PPP চুক্তি স্বাক্ষরিত হয়। BIFFL-এর প্রতিবেদন অনুযায়ী প্রকল্পে তাদের প্রথম ঋণ বিতরণ হয় এপ্রিল ২০২২-এ। এগুলি ঐতিহাসিক মাইলফলক, বর্তমান সড়ক পরিচালনার অবস্থা নয়। <a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA প্রকল্প পরিচিতি</a>; <a href=\"https://www.biffl.org.bd/uploads/images/reports/BIFFL%20Annual%20Report%202022%20Final%20Update.pdf\">BIFFL বার্ষিক প্রতিবেদন ২০২২, পৃষ্ঠা ৮৮</a>।</p>" + historical('bn', "<p><strong>৩১ ডিসেম্বর ২০২৪-এর নির্মাণ চিত্র:</strong> আগের প্রকল্প পাতায় সার্বিক অগ্রগতি ৬৯.১১%, মাটির কাজ ৮২.৮৯%, পেভমেন্ট ৫৩.৯৫%, ভিত্তি ১০০% ও অবকাঠামো ৯০.৯% বলা হয়েছিল।</p><p>প্রাথমিক প্রকল্প বিনিয়োগ ৪১২ মিলিয়ন মার্কিন ডলার এবং নির্ধারিত সূচনার তারিখ ১৫ মে ২০২২ উল্লেখ ছিল। এগুলি আগের সাইটের তথ্য, হালনাগাদ আর্থিক বিবরণী নয়।</p><p>জুলাই ও ডিসেম্বর ২০২৫-এর পুরোনো উদ্বোধনের লক্ষ্য ইতোমধ্যে পেরিয়ে গেছে। এগুলি অবশিষ্ট সড়ক খোলা থাকার প্রমাণ নয়। প্রকাশিত পরিচালনার অবস্থা রুট মানচিত্রে দেখুন।</p>"),
        },
        zh: {
          heading: '工期与投资',
          body:
            "<p>项目历程：PPP 合同于 2018 年 12 月 6 日签署。BIFFL 报告称，首次向项目发放贷款是在 2022 年 4 月。这些属于历史里程碑，并非道路当前运营状态。<a href=\"https://www.pppo.gov.bd/projects-dhaka-bypass.php\">PPPA 项目资料</a>；<a href=\"https://www.biffl.org.bd/uploads/images/reports/BIFFL%20Annual%20Report%202022%20Final%20Update.pdf\">BIFFL 2022 年报，第 88 页</a>。</p>" + historical('zh', "<p><strong>截至 2024 年 12 月 31 日的施工记录：</strong>旧项目页面报告总体进度为 69.11%，土方 82.89%，路面 53.95%，基础 100%，结构 90.9%。</p><p>旧网站还提及初始项目投资 4.12 亿美元，约定开工日期为 2022 年 5 月 15 日。这些是旧网站所述数据，并非最新财务报表。</p><p>原定 2025 年 7 月及 12 月的开放目标日期已经过去，不能据此认定剩余路段已开放。已公布的运营状态请查看路线地图。</p>"),
        },
      },
    },
  ],
      ...
      data: {
        en: {
          ...
          body:
            ...
            + historical('en', "<p>The previous site described emergency call points, ambulance and towing support. Their present availability and a dedicated expressway number have not been verified. Follow roadside instructions and contact the national emergency service in an emergency. The website contact form is for general enquiries.</p>"),
        },
        bn: {
          ...
          body:
            ...
            + historical('bn', "<p>আগের সাইটে জরুরি কল পয়েন্ট, অ্যাম্বুলেন্স ও টোয়িং সহায়তার উল্লেখ ছিল। বর্তমানে এসব সেবার প্রাপ্যতা ও এক্সপ্রেসওয়ের নির্দিষ্ট নম্বর যাচাই করা হয়নি। সড়কের নির্দেশনা অনুসরণ করুন এবং জরুরি অবস্থায় জাতীয় জরুরি সেবায় যোগাযোগ করুন। ওয়েবসাইটের ফরম সাধারণ অনুসন্ধানের জন্য।</p>"),
        },
        zh: {
          heading: '车辆故障时',
          body:
            ...
            + historical('zh', "<p>旧网站曾介绍紧急呼叫点、救护车及拖车支持。这些服务目前是否提供及快速路专用号码尚未核实。请遵循路边指示，紧急时联系国家紧急服务。网站联系表单用于一般咨询。</p>"),
        },
      },
    },
  ],
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            historical('en', "<p>The previous website described school support, community visits, pandemic relief supplies, staff training and construction quality-control activities. The gallery preserves project photographs of construction work, a school plaque presentation and joint project ceremonies.</p><p>The archived folder contains no public environmental assessment, management plan or monitoring report for download. Request those documents through the contact form.</p>"),
        },
        bn: {
          heading: 'পরিবেশগত ও সামাজিক মূল্যায়ন',
          body:
            historical('bn', "<p>আগের সাইটে বিদ্যালয়ে সহায়তা, কমিউনিটি পরিদর্শন, মহামারির সময় ত্রাণসামগ্রী, কর্মীদের প্রশিক্ষণ ও নির্মাণের মান নিয়ন্ত্রণের বর্ণনা ছিল। গ্যালারিতে নির্মাণকাজ, বিদ্যালয়ে স্মারক প্রদান ও যৌথ প্রকল্প অনুষ্ঠানের ছবি সংরক্ষিত রয়েছে।</p><p>পুরোনো ফোল্ডারে ডাউনলোডযোগ্য প্রকাশ্য পরিবেশ মূল্যায়ন, ব্যবস্থাপনা পরিকল্পনা বা পর্যবেক্ষণ প্রতিবেদন নেই। নথির জন্য যোগাযোগ ফরম ব্যবহার করুন।</p>"),
        },
        zh: {
          heading: '环境与社会影响评估',
          body:
            historical('zh', "<p>旧网站介绍了学校支持、社区走访、疫情物资援助、员工培训与施工质量管理。图库保留了施工、学校牌匾交接及联合项目活动的照片。</p><p>归档文件夹中没有可下载的公开环境评估、管理计划或监测报告。请通过联系表单申请这些文件。</p>"),
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            "<p>No tender notices are currently listed on this website. Published notices will include the reference, scope, submission deadline and document access details.</p>",
        },
        bn: {
          heading: 'চলমান দরপত্র',
          body:
            "<p>এই ওয়েবসাইটে বর্তমানে কোনো দরপত্র বিজ্ঞপ্তি তালিকাভুক্ত নেই। প্রকাশিত বিজ্ঞপ্তিতে সূত্র নম্বর, কাজের বিবরণ, জমার সময়সীমা ও নথি পাওয়ার তথ্য থাকবে।</p>",
        },
        zh: {
          heading: '现行招标',
          body:
            "<p>本网站目前未列出招标公告。发布时将注明编号、范围、提交截止日期及文件获取方式。</p>",
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            pending('en', "Supplier registration requirements and a dedicated procurement contact are awaiting confirmation. Use the general contact form for supplier and tender enquiries."),
        },
        bn: {
          heading: 'সরবরাহকারী হিসেবে নিবন্ধন',
          body:
            pending('bn', "সরবরাহকারী নিবন্ধনের শর্ত ও ক্রয়সংক্রান্ত নির্দিষ্ট যোগাযোগ নিশ্চিতকরণের অপেক্ষায় রয়েছে। সরবরাহকারী ও দরপত্রের অনুসন্ধানে সাধারণ যোগাযোগ ফরম ব্যবহার করুন।"),
        },
        zh: {
          heading: '供应商登记',
          body:
            pending('zh', "供应商注册要求及采购专用联系方式尚待确认。供应商和招标咨询请使用一般联系表单。"),
        },
      },
    },
  ],
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            pending('en', "The public land acquisition and compensation record is awaiting publication, including affected areas and resettlement assistance. Use the contact form to request information about a specific case."),
        },
        bn: {
          heading: 'অধিগ্রহণ ও ক্ষতিপূরণের নথি',
          body:
            pending('bn', "ক্ষতিগ্রস্ত এলাকা ও পুনর্বাসন সহায়তাসহ ভূমি অধিগ্রহণ এবং ক্ষতিপূরণের প্রকাশ্য নথি প্রকাশের অপেক্ষায় রয়েছে। নির্দিষ্ট বিষয়ে তথ্যের জন্য যোগাযোগ ফরম ব্যবহার করুন।"),
        },
        zh: {
          heading: '征地与补偿记录',
          body:
            pending('zh', "土地征收与补偿的公开记录尚待公布，包括受影响区域及安置援助。查询具体事项，请使用联系表单。"),
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            pending('en', "The tariff notification reference, issue date and original document are awaiting publication. Confirmed rates for the open section are available on the toll page."),
        },
        bn: {
          heading: 'নথিভুক্ত বিজ্ঞপ্তি',
          body:
            pending('bn', "টোল প্রজ্ঞাপনের সূত্র নম্বর, প্রকাশের তারিখ ও মূল নথি প্রকাশের অপেক্ষায় রয়েছে। খোলা অংশের নিশ্চিত হার টোল পাতায় পাওয়া যাবে।"),
        },
        zh: {
          heading: '存档公告',
          body:
            pending('zh', "收费通知的编号、发布日期及原件尚待公布。已开放路段的确认费率可在收费页面查看。"),
        },
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        en: {
          ...
          body:
            historical('en', "<p>The previous website used info@dbedc.com for general enquiries. It did not publish a dedicated grievance officer, response deadline or escalation process. You can submit an enquiry using the contact form on this site while the dedicated details are updated.</p>"),
        },
        bn: {
          heading: 'কীভাবে আমাদের কাছে পৌঁছাবেন, এবং তারপর কী হয়',
          body:
            historical('bn', "<p>আগের সাইটে সাধারণ অনুসন্ধানের জন্য info@dbedc.com ব্যবহার করা হতো। নির্দিষ্ট অভিযোগ কর্মকর্তা, উত্তরের সময়সীমা বা পরবর্তী ধাপ প্রকাশিত ছিল না। নির্দিষ্ট তথ্য হালনাগাদের সময় এই সাইটের যোগাযোগ ফরম ব্যবহার করতে পারেন।</p>"),
        },
        zh: {
          heading: '如何联系我们，以及后续流程',
          body:
            historical('zh', "<p>旧网站将 info@dbedc.com 用于一般咨询，未列出专门投诉负责人、回复时限或升级处理流程。在专用信息更新期间，可使用本网站的联系表单提交咨询。</p>"),
        },
      },
    },
    {
