...
export default {
  ...
  fields: [
    ...
    // 0 shows every record. The home page shows the first five and points the
    // reader at /travel/route for the rest, through the link fields below —
    // the same label + target pair toll-preview uses.
    { name: 'limit', type: 'number', label: 'Rows to show (0 = all)', default: 0 },
    { name: 'linkLabel', type: 'text', label: 'Link label (below the table)' },
