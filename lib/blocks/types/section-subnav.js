  ...
  fields: [
    {
      ...
      // Filled from the menus that exist, at render time (W8N.3); the literal
      // list below is what a no-database build offers.
      optionsFrom: 'section-menus',
    ...
    // A hub page shows its section as cards with a line about each page; a
    // page inside the section shows the row, with the current page marked.
    {
      name: 'layout', type: 'select', label: 'Layout', default: 'row',
      options: [
        { value: 'row', label: 'Row of links (a page inside the section)' },
        { value: 'cards', label: 'Cards with descriptions (the front page of the section)' },
      ],
    },
  ],
