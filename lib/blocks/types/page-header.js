...
export default {
  ...
  fields: [
    ...
    // The date the page's text last changed, from the records: for statutory
    // and policy pages, where a reader needs to know how current the page is.
    { name: 'showUpdated', type: 'select', label: 'Show "last updated"', default: 'no', options: [{ value: 'no', label: 'No' }, { value: 'yes', label: 'Yes, the date the text last changed' }] },
  ],
