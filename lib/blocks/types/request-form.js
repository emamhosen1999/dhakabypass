  ...
  fields: [
    {
      ...
      options: [
        ...
        { value: 'fleet_account', label: 'Fleet account application (FA-)' },
        { value: 'etc_tag', label: 'Electronic toll tag application (ET-)' },
        { value: 'loyalty', label: 'Frequent traveller registration (LY-)' },
      ],
    },
