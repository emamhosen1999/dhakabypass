...
export function localeHref(href, locale) {
  ...
  // The bare root is the LEGACY site's address, rewritten to /en by
  // next.config.mjs — a Bangla page linking "home" to `/` would land its
  // reader on the English front page. The locale root is what was meant.
