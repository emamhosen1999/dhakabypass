...
import adSlot from './types/ad-slot.js';
...
const ALL = [
  ...
  // Advertising (19 Sep). Renders nothing unless ADSENSE_CLIENT is set, and
  // nothing at all on the pages lib/ads/config.js protects.
  adSlot,
