...
export const FOOTER_GROUPS = [
  {
    ...
    links: [
      ...
      // What a driver needs after something has gone wrong (W8N.3, NAV-IA-03).
  ...
  },
  {
    ...
    links: [
      ...
      // The four a lender and a regulator come for, and the four the column
      // omitted (W8N.3, NAV-IA-03).
