 ...
 */
export const CHROME_MENU_SLUGS = ['main', 'cta', 'footer', 'legal'];

/**
 * The built-in fallback only. The live list is every menu in the database that
 * is not chrome — see lib/menus/section-menus.js (W8N.3). It stays here so a
 * build with no database, and the block's own offline options, still name the
 * travel menu the six travel pages depend on.
 */
