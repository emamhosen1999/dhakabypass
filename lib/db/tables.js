...
export const EXPECTED_TABLES = Object.freeze([
  'advisories', 'alert_broadcasts', 'alert_subscribers', 'audit_log', 'cameras', 'block_translations', 'blocks', 'contact_messages',
  ...
  'news_updates', 'newsletter_subscribers', 'page_translations', 'pages', 'record_history', 'redirects',
  'revisions', 'route_meta', 'schema_migrations', 'segments', 'service_request_events', 'service_requests',
  'site_settings', 'toll_od_rates', 'toll_rates', 'traffic_history', 'traffic_monthly', 'trash', 'ui_strings', 'users',
]);
